...
@section('content')
  ...
  {{-- <div class="text-h text-center">(Con Derecho a Crédito Fiscal)</div> --}}
  <div class="separe"></div>
  
  <table class="list-table">
    <tr>
      <td style="width: 25%;"><div class="lbl-info">Fecha:</div></td>
      <td style="width: 40%;"><div class="text-h">{{ date('d/m/Y H:i') }}</div></td>
      <td style="width: 20%;"><div class="lbl-info text-rights">NIT/CI:</div></td>
      <td style="width: 15%;"><div class="text-h">{{ $datos->cliente->nit }}</div></td>
    </tr>
    <tr>
      <td><div class="lbl-info">Nombre/Razón social:</div></td>
      <td><div class="text-h">{{ $datos->cliente->razon_social }}</div></td>
      {{-- <td>Dirección:</td> --}}
      {{-- <td>{{ $datos->cliente->direccion }}</td> --}}
      <td><div class="lbl-info text-rights">Telf/Cel.:</div></td>
      <td><div class="text-h">{{ $datos->cliente->celular }}</div></td>
    </tr>
  </table>
  <div class="separe"></div>
